...
#define TEXT_COLOR  {248, 242, 73, 0}
#define TEXT_BGCOLOR {7, 40, 69, 255}
...
int main(int argc, char* argv[]) 
{
    ...
    SDL_Surface * textSurface = TTF_RenderText_Blended_Wrapped(font, getVisibleBuffer(), textColor, SCREENWIDTH);
